...
{
$error="You can't cancel the booking before 24 hours! Contact the admin for emergency reason!!";
}
}
}
}
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">TH-Travel Hive</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
...
<?php }
  ...
  ?>
  / <a href="generate-invoice.php?bkid=<?php echo htmlentities($result->bookid);?>">Get Invoice</a>
